...
class LegalNotice extends Component {
  render() {
    return (
          <div className="content-legals-notices">
          <h2>Privacy Policy of <span class="website_url">footfem.com</span></h2>

            <p>At <span class="website_name">FootFem</span>, we collect and manage user data according to the following Privacy Policy.</p>
